...
# Export
ggsave(g, filename=file.path(plotdir, "FigS7_toxicities_for_non_bivalves.png"), 
...
ggsave(g, filename=file.path(plotdir, "FigS7_toxicities_for_non_bivalves_2col.png"), 
...
ggsave(g, filename=file.path(plotdir, "FigS7_toxicities_for_non_bivalves_2row.png"), 
