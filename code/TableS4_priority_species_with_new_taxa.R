...
# Read data
data_orig <- read.csv(file=file.path(tabledir, "TableSX_priority_species_new_taxa_raw.csv")) # made by Fig6_shellfish_priorities.R
diversity_orig <- read.csv(file=file.path(tabledir, "TableSX_taxa_diversity.csv")) # made by TableX_diversity_by_taxa.R
